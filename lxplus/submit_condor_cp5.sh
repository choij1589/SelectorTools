...
./Utilities/scripts/submitMakeHistFileToCondor.py \
	-f DYm50_cp5_MiniToNano -a ZGen -s None --input_tier NanoAOD \
	-d /afs/cern.ch/work/c/choij/SelectorSubmit/Submit_DYm50_cp5_MiniToNanotest \
	-n 10 -q workday --removeUnmerged \
	--merge /eos/home-c/choij/EPR/SelectorOutput/DrellYan/DYm50_cp5_MiniToNano_test.root 0.1 \
	--selectorArgs lhe=1 prefsr=1 born=1 bare=1 wSignOnly=1 \
	--submit --force --local
